...
namespace MesgakiManagement.UI
{
    ...
    public class CustomerQueueImage : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        ...
        public void OnClick()
        {
            ...
            var a = GameObject.Find("CustomerInfoPanel");
            CustomerInfoPanel c = a.GetComponent<CustomerInfoPanel>();
            c.updateViewCustomerInfo(mockOjisan);
        }
    }
}